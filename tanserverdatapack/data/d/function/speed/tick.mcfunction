...
execute as @a if score @s ucarrot matches 1.. if score @s scool matches 0 if data entity @s {SelectedItem:{components:{"minecraft:item_model":"minecraft:speed"}}} at @s run scoreboard players set @s speed 20
execute as @a if score @s ucarrot matches 1.. if score @s scool matches 0 if items entity @s weapon.offhand *[item_model="minecraft:speed"] at @s run scoreboard players set @s speed 20
...
#制御
    ...
    execute as @a if score @s speed matches 1..20 at @s run scoreboard players remove @s speed 1
...
execute as @a if score @s speed matches 1 at @s run scoreboard players set @s speed 21
